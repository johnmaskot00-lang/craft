...
9. В статьях запрещены SVG-анимации. Живость — фото, callout, pull-quote. До 3 фото. Две секции .ref-offer с URL оффера владельца + нативные ссылки на продукт в тексте. Не ставь CTA на конкурентов. «Читайте также» — только реальные URL сайта.
