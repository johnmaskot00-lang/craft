...
9. В статьях запрещены SVG-анимации. Живость — фото, callout, pull-quote. До 3 фото. Оффер владельца — нативно в тексте статей (суть продукта), не спамом по всей главной. Не ставь CTA на конкурентов. «Читайте также» — только реальные URL сайта.
